...
def chat():
    ...
    while True:
        ...
        if results[results_index] > 0.7:
            ...
            print("Sorry, I didn't get your question. You can try again or ask other question")
...
def bmi():
    ...
    print(
        "Do you know your waist size ? It will help us in giving you better results. If yes then print 'yes' else print 'no'")
    ans = input()
